...
public enum Messages {
    ...
    PLAYER_NOT_PLAYING(PREFIX.getMessage().append(mm("<color:#bf2a37>Dieser Spieler spielt aktuell kein Vier-Gewinnt!"))),
    NO_OPEN_GAMES(PREFIX.getMessage().append(mm("<color:#bf2a37>Aktuell gibt es kein offenes <color:#bf2a37>Spiel."))),
